...
class DataSearchAll extends SearchDelegate<String> {
  DataSearchAll({this.controller});
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (controller.allchars[index].name
                        .toLowerCase()
                        .contains(query.toLowerCase()) ||
                    controller.allchars[index].name == query.toLowerCase()) {
                  return Column(
                    children: [
                      Padding(
